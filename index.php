                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 col-12 ps-lg-4">
                            <div class="berita-text">
                                ...
                                <a class="btn btn-outline-success" href="baca_selekapnya_penhunjung.php?id=1">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 col-12 ps-lg-4">
                            <div class="berita-text">
                                ...
                                <p>Campaign ini telah selesai dan telah tersalurkan ke orang yang bersangkutan.</p>
                                <a class="btn btn-outline-success" href="baca_selekapnya_penhunjung.php?id=2">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 col-12 ps-lg-4">
                            <div class="berita-text">
                                ...
                                <p>Campaign ini telah selesai dan telah tersalurkan ke orang yang bersangkutan.</p>
                                <a class="btn btn-outline-success" href="baca_selekapnya_penhunjung.php?id=3">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                </div>
